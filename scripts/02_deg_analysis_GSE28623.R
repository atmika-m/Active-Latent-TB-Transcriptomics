############################################################
# Differential Expression Analysis: GSE28623
...
dir.create("results/GSE28623", recursive = TRUE, showWarnings = FALSE)

# Download GEO dataset
gse <- getGEO("GSE28623", GSEMatrix = TRUE)
...
# Save outputs
write.csv(deg, "results/GSE28623/DEG_table.csv")
write.csv(expr_clean, "results/GSE28623/expression_matrix.csv")
write.csv(metadata_clean, "results/GSE28623/metadata_clean.csv")

# Summary
cat("GSE28623 analysis complete.\n")
cat("Group counts:\n")
